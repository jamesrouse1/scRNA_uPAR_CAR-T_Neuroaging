...
write_csv(deg, file.path(file.path(outdir, "DEG"), paste0("uPARplus_vs_uPARminus", "_all_genes.csv")))

write_csv(filtered, file.path(file.path(outdir, "DEG"), paste0("uPARplus_vs_uPARminus", "_filtered_for_enrichr.csv")))
...
if (length(results)) write.xlsx(results, file.path(file.path(outdir, "DEG"), paste0("uPARplus_vs_uPARminus", "_enrichr.xlsx")),
  overwrite = TRUE)
