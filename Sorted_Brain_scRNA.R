...
run_sorted_brain <- function() {
    ...
    samples <- data.frame(sample = c("F_neg", "F_plus", "M_neg", "M_plus"), path = file.path(alex_root, "dataset1", 
        c("Amor_CAV17_Female_UPARneg/filtered_feature_bc_matrix", "Amor_CAV17_Female_UPARpos/filtered_feature_bc_matrix", 
            "Amor_CAV16_Male_UPARneg/filtered_feature_bc_matrix", "Amor_CAV16_Male_UPAR_pos/filtered_feature_bc_matrix")), 
    ...
    obj <- attach_labels_from_rds(obj, file.path(alex_root, "dataset1/seurat_objs/annotated_cell_types_d1.RDS"), 
